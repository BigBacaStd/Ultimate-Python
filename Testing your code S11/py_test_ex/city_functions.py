...
Write a second test called test_city_country_popylation() that verifies
you can call your function with the values 'santiago', 'chile' and 'population'
= 5000000. Run the test one more time, and make sure this new test passes.

"""


def city_country_name(city, country, population =''):
    """Generates a neatly formatted city and country name"""
    if population:
